---
name: gudai-skill
description: 古代权谋短篇小说创作技能包。执行大纲、人物、目录、章节的专业创作，基于古代权谋创作法则和文白相济的写作风格生成高质量小说内容。
---

# 古代权谋小说创作 Skill

[技能说明]
    专业的古代权谋短篇小说创作技能包，覆盖故事构思、人物塑造、章节规划、正文写作全流程。根据不同创作阶段，读取对应的创作资源并生成符合古代权谋规范的小说内容。
...
[执行流程]
    ...
    第三步：执行专业创作
        **大纲创作**：
            ...
            - 遵循 outline-method.md 的古代权谋创作方法论
            - 应用 output-style.md 的文白相济写作风格
            - 参考 examples/outline-example.md 的示例
            - 生成包含以下内容的完整大纲：
                • 小说信息（书名、类型：古代权谋、故事调性）
                • 核心梗概（一句话）
                • 导语（150-200字，包含势力格局和关键证物）
        ...
        **人物创作**：
            ...
            - 遵循 outline-method.md 中的古代权谋人物塑造指导
            - 应用 output-style.md 的文白相济写作风格
            - 参考 examples/character-example.md 的示例
            - 生成包含以下内容的人物小传：
                • 主要角色（3-5个，详细描述，强调势力归属和谋略）
                • 反派角色（如有）
                • 重要配角（如有）
                • 其他角色（如有）
            - 确保人物与权力格局匹配，忠义困境清晰
        ...
        **目录创作**：
            ...
            - 遵循 outline-method.md 的古代权谋章节规划方法
            - 应用 output-style.md 的写作风格
            - 生成固定5章的章节目录，与大纲的起承转合结构对应
            - 每章包含：章节标题 + 一句话剧情简介（体现谋略博弈）
            - 确保起承转合布局合理，成局失衡清晰
        
        **章节创作**：
            基于全部上下文文档和读取的资源：
            - 严格按照 templates/chapter-template.md 的格式结构
            - 严格遵循 output-style.md 的文白相济写作风格和章节创作方法（最重要）
...
[创作原则]
    ...
    - **质量标准原则**：
        • 大纲：核心冲突清晰，势力格局明确，故事结构完整，固定起承转合结构，2000-3000字
        • 人物：性格鲜明，势力归属清晰，忠义困境深刻，与故事匹配
        • 目录：固定5章，与大纲的起承转合结构对应，布局合理，体现失衡
        • 章节：2000-3000字，风格统一，谋略纵横，推进剧情

[注意事项]
    - 确保每个阶段的必需资源都已读取完整
    - 不仅读取文档内容，还要深入理解其含义
    - output-style.md中的文白相济风格要求是强约束，必须严格遵守
    - templates/中的格式是必须遵循的，任何偏离都可能导致问题
    - 短篇小说固定为5章结构，采用起承转合布局
    - 创作内容必须完整、连贯、符合古代权谋特点
    - 始终使用中文创作